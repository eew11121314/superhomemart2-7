...
import 'package:superhomemart2/Pagemain/order_main/cart/cart_provider_m.dart'; // เพิ่มการนำเข้า
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _logout() async {
    ...
    if (username != null) {
      ...
      cartProvider
          .clearCart(); // ล้างข้อมูลตะกร้าสินค้าในหน่วยความจำ แต่ไม่ลบใน SharedPreferences
    }
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: CircleAvatar(
                                ...
                                child: _image == null &&
                                        (userData!['image_path'] == null ||
                                            userData!['image_path'].isEmpty)
                                    ? Text(
                                        userData!['fname']
                                            [0], // แสดงตัวอักษรแรกของชื่อผู้ใช้
                                        style: TextStyle(
                                          fontSize: imageSize,
                                          color: Colors.white,
                                        ),
