    ...
    if (_username != null) {
      setState(() {
        widget.fullNameController.text =
            prefs.getString('fullName_$_username') ?? '';
        widget.companyController.text =
            prefs.getString('company_$_username') ?? '';
        widget.taxIdController.text = prefs.getString('taxId_$_username') ?? '';
        widget.houseNumberController.text =
            prefs.getString('houseNumber_$_username') ?? '';
        widget.provinceController.text =
            prefs.getString('province_$_username') ?? '';
        widget.districtController.text =
            prefs.getString('district_$_username') ?? '';
        widget.subDistrictController.text =
            prefs.getString('subDistrict_$_username') ?? '';
        widget.postalCodeController.text =
            prefs.getString('postalCode_$_username') ?? '';
        widget.phoneController.text = prefs.getString('phone_$_username') ?? '';
  ...
  Future<void> _saveAddress() async {
    ...
    if (_username != null) {
      await prefs.setString(
          'fullName_$_username', widget.fullNameController.text);
      await prefs.setString(
          'company_$_username', widget.companyController.text);
      await prefs.setString('taxId_$_username', widget.taxIdController.text);
      await prefs.setString(
          'houseNumber_$_username', widget.houseNumberController.text);
      await prefs.setString(
          'province_$_username', widget.provinceController.text);
      await prefs.setString(
          'district_$_username', widget.districtController.text);
      await prefs.setString(
          'subDistrict_$_username', widget.subDistrictController.text);
      await prefs.setString(
          'postalCode_$_username', widget.postalCodeController.text);
      await prefs.setString('phone_$_username', widget.phoneController.text);
      await prefs.setString('email_$_username', widget.emailController.text);
      await prefs.setString('shippingCost_$_username',
          widget.shippingCostController.text); // บันทึกค่าจัดส่ง
      await prefs.setString('textAbout_$_username',
          widget.textAboutController.text); // บันทึกข้อความเกี่ยวกับ
    }
